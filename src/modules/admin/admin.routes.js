...
const adminAuthRoutes = require(path.join(
    process.cwd(),
    "/src/modules/admin/admin-auth/admin-auth.routes",
));
const adminCategoryRoutes = require(path.join(
    process.cwd(),
    "/src/modules/admin/admin-category/admin-category.routes",
));
