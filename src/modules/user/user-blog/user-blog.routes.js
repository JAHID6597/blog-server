...
router.get('/api/user/blogs/liked', userAuth, controller.getLikedBlogsByPrivateUser);

router.get('/api/user/:userName/blogs/bookmarked', controller.getBookmarkedBlogsByPublicUser);
router.get('/api/user/blogs/bookmarked', userAuth, controller.getBookmarkedBlogsByPrivateUser);

router.get('/api/user/:userName/blogs/comments', controller.getCommentsByPublicUser);
router.get('/api/user/blogs/comments', userAuth, controller.getCommentsByPrivateUser);
