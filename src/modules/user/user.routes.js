...
const userAuthRoutes = require(path.join(
    process.cwd(),
    "/src/modules/user/user-auth/user-auth.routes",
));
const userBlogRoutes = require(path.join(
    process.cwd(),
    "/src/modules/user/user-blog/user-blog.routes",
));
const userFollowRoutes = require(path.join(
    process.cwd(),
    "/src/modules/user/user-follow/user-follow.routes",
));
...
router
    ...
    .put(
        userAuth,
        validateFile(multer.single("profilePicture")),
